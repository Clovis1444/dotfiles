...
-- CLOVIS: Disable sleep mode(screen turning off after some time)
awful.spawn.with_shell("xset s off")
awful.spawn.with_shell("xset -dpms")
awful.spawn.with_shell("xset s noblank")

-- Keyboard layout switcher
awful.spawn.with_shell("setxkbmap -layout us,ru -variant , -option grp:alt_shift_toggle")
--
...
-- CLOVIS
    awful.key({ "Shift" }, "Alt", function()
        -- Do nothing: shortcut already set before using awful.spawn.with_shell()
    end, { description = "change keyboard layout", group = "system" }),
    --
    ...
    awful.key({ "Control" }, "Print", function()
        awful.spawn(screenshot_tool)
    end, { description = "take screenshot", group = "launcher" }),
    awful.key({ "Control" }, "g", function()
        awful.spawn(gif_tool)
    end, { description = "record gif", group = "launcher" }),
    --
